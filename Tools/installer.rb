...
puts `pkgbuild --root \"#{@installer_root}\" --identifier com.bigmousestudio.soundflower --version #{@version} --install-location "/" \"#{@build_folder}/Soundflower.pkg\" --ownership preserve  --scripts \"#{@svn_root}/Installer/scripts\" --sign \"Developer ID Installer: Dongchen Zhang\"`
